...
if __name__ == '__main__':
    ...
    for i in range(10):
        print("\n============================================\nrecuit\n=========================================\n")
        alpha = 0.935 - (i + 1) / 1000
        print("ALPHA = ", alpha)
        begin = time.time()
        sol, decomp = recuit.run(N, B, E, quantities, sol, decomp, alpha = alpha)
        printsol(sol, decomp)
    ...
    print("\n============================================\nrecuit\n=========================================\n")
    begin = time.time()
    sol2,decomp2 = recuit.run(N,B,E,quantities,sol3,decomp3)
    ...
    print("\n============================================\nlocalSearch\n=========================================\n")
    begin = time.time()
    sol1,decomp1 = localSearch.run(N,B,E,quantities,sol2,decomp2)
